...
if choice =="Bản đồ":
    ...
    **- Tỉnh Lạng Sơn** là một tỉnh miền núi nằm ở phía Bắc Việt Nam, với điều kiện kinh tế còn nhiều khó khăn. Ngành công nghiệp và dịch
                                vụ tại đây phát triển chậm do thiếu đầu tư và đào tạo nghề. Do đó, chất lượng lao động vẫn chưa cao, 
                                lực lượng lao động có xu hướng tăng trưởng chậm với trình độ thấp, dẫn đến tỷ lệ thất nghiệp cao.\n
    **-Thành phố Hồ Chí Minh** là trung tâm kinh tế, thương mại và tài chính lớn nhất cả nước, với tốc độ tăng trưởng kinh tế luôn ở mức cao. 
                                Các ngành công nghiệp, dịch vụ và xây dựng tại đây luôn có nhu cầu lao động lớn với số lượng lớn.\n
    Bên cạnh đó, Thành phố Hồ Chí Minh là thành phố đông dân nhất Việt Nam, với dân số hơn 9 triệu người. 
                                Mỗi năm, có hàng trăm nghìn người từ các tỉnh thành khác đến thành phố này lập nghiệp, 
                                vì thế nguồn cung lao động tại đây ngày càng tăng nhanh. Tuy nguồn lao động tại thành phố luôn dồi dào, 
                                nhưng trình độ tay nghề và kỹ năng chuyên môn của nhiều lao động vẫn còn hạn chế, không đáp ứng được yêu 
                                cầu của thị trường lao động. Điều này dẫn đến tình trạng thất nghiệp ngày càng cao tại thành phố này.\n
    **-** Vùng tập trung các tỉnh thành phố có màu đậm hơn tập trung ở vùng **Đồng Bằng Sông Cửu Long**. **Đồng Bằng Sông Cửu Long** 
                                ...
                                dân trong vùng.
    Bên cạnh đó, Đồng Bằng Sông Cửu Long có dân số đông đúc, đặc biệt là ở các tỉnh và thành phố lớn như **Cần Thơ** và các tỉnh 
        ...
        if selected_year=='2018-2022':
            ...
            with left_column:
                ...
                if choice=="Thành thị":
                    ...
                    folium_static(mymap, width=900, height=800)
                    with st.expander("📝See note:"):
                        st.write("""**Ở thành thị**, chi phí sinh sống ở thành thị thường cao hơn so với nông thôn, bao gồm chi phí nhà ở, đi lại, và dịch vụ hàng ngày. Điều này có thể làm cho việc tìm kiếm một công việc có thu nhập ổn định trở nên khó khăn hơn.""")
                ...
                if choice=="Nông thôn":
                    ...
                    with st.expander("📝See note:"):
                        st.write("""**Nông thôn** thường có ít cơ hội việc làm hơn so với thành thị do sự thiếu hụt đa dạng trong ngành nghề và 
                                 lĩnh vực kinh doanh. Các ngành nghề chủ yếu ở nông thôn thường liên quan đến nông nghiệp và ngành công nghiệp 
                                 cơ bản, trong khi các thành phố lớn thường có một loạt các ngành công nghiệp và dịch vụ khác nhau.""")
